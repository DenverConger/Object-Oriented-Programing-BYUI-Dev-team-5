...
<tileset version="1.4" tiledversion="1.4.3" name="tmw_desert_spacing" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="54" columns="9">
 <image source="../images/tmw_desert_spacing.png" width="298" height="199"/>
 <terraintypes>
  <terrain name="Brick" tile="37"/>
  <terrain name="Stone" tile="27"/>
  <terrain name="Cracked Sand" tile="15"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
 ...
 <tile id="28" terrain=",,1,1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="13" width="32" height="9"/>
  </objectgroup>
 </tile>
 <tile id="29" terrain=",,1,">
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="14">
    <polygon points="0,0 22,0 22,18 14,18 14,7 0,7"/>
   </object>
  </objectgroup>
 </tile>
 ...
 <tile id="36" terrain=",1,,1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="13" y="0" width="10" height="32"/>
  </objectgroup>
 </tile>
 ...
 <tile id="39" terrain="1,1,1,">
  <objectgroup draworder="index" id="2">
   <object id="1" x="32" y="14">
    <polygon points="0,0 -19,0 -19,18 -10,18 -10,8 0,8"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="40" terrain="1,1,,1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="13">
    <polygon points="0,0 22,0 22,19 13,19 13,9 0,9"/>
   </object>
  </objectgroup>
 </tile>
 ...
 <tile id="48" terrain="1,,1,1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="13" y="0">
    <polygon points="0,0 0,22 19,22 19,13 9,13 9,0"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="49" terrain=",1,1,1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="22" y="0">
    <polygon points="0,0 0,21 -22,21 -22,13 -9,13 -9,0"/>
   </object>
  </objectgroup>
 </tile>
</tileset>
